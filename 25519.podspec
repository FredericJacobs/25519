Pod::Spec.new do |spec|
  ...
  spec.preserve_path = 'Sources/ed25519/**/*.h'
  spec.authors      = { 'Frederic Jacobs' => 'github@fredericjacobs.com' }
  spec.summary      = 'Simple Objective-C wrapper over Curve25519 and Ed25519 that does signing, verification, key generation, and key agreement with Curve25519 keys.'
